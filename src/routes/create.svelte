...
<Banner>
	<div class="my-auto">
		...
		<p>Now's your time to shine. Fill out this simple form to add your petition to GoVote!</p>
	</div>
</Banner>
...
<section class="container mx-auto grid grid-cols-1 gap-12 px-2 lg:grid-cols-2 lg:px-0">
	<form>
		...
		<Select
			...
			options={['College of Engineering', 'College of Music', 'College of Science']}
		/>
		<button
			type="submit"
			class="float-right my-2 inline-flex items-center rounded-md bg-slate-500 text-slate-50 px-4 py-2"
		>
